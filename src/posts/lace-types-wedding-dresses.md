---
title: "Types of lace in wedding dresses: Chantilly, Alençon, guipure, corded and embroidered tulle"
description: "What each lace looks and feels like, how it changes a dress, why two lace gowns can look nothing alike, and the questions to ask about samples, swatches and care."
date: 2026-08-25
category: fabrics
faq:
  - q: "What is the difference between Chantilly and Alençon lace?"
    a: "Chantilly is fine, flat and very light, with the pattern drawn in thin thread on a delicate net, so it drapes and moves. Alençon has each motif outlined with a heavier cord, which raises the pattern, adds weight and makes it hold a shape. Chantilly suits sleeves and overlays; Alençon suits bodices and fitted skirts."
  - q: "Is French lace better than other lace?"
    a: "Lace from the traditional French mills is made on Leavers machines and has a finer, more even net and a pattern that looks drawn rather than stamped. Good lace is made elsewhere too. The useful distinction is between Leavers lace and knitted Raschel lace, which is coarser and slightly shinier, so ask what the lace is rather than where it is from."
  - q: "Can I get a swatch of the lace before ordering?"
    a: "Most makers will give you a small piece of the actual lace with the intended lining, and you should ask for one. It lets you check the colour against your veil and accessories in daylight at home, and confirm that the delivered lace matches the sample you tried on. A refusal is worth noticing."
  - q: "How do I stop lace from snagging on the day?"
...
**What it looks like.** A fine, flat lace with delicate floral or scrolling motifs on a very fine net. The pattern is drawn with thin thread and often shaded, so it reads as a soft drawing rather than a raised embroidery.
...
**What it looks like.** A floral lace with one distinctive feature: each motif is outlined with a heavier cord, which raises the pattern from the net and gives it definition. The net ground is fine and the motifs tend to be dense and formal.
...
**What it looks like.** A lace with no net ground at all. The motifs, usually bold flowers, leaves or geometric shapes, are joined to each other by small bars or plaits, so the pattern is the fabric. Where there is no motif there is a hole.
...
**What it looks like.** A general term rather than a strict type: any lace whose motifs are outlined with a raised cord. Alençon is the classic example, but many modern laces on a heavier net use a thicker, glossier cord with larger, more open motifs, and that changes the whole look.
...
| Lace | Ground | Weight | Transparency | Typical use |
|---|---|---|---|---|
| Chantilly | Fine net | Very light | High | Sleeves, overlays, soft dresses |
| Alençon | Fine net, corded motifs | Medium | Medium | Bodices, fitted skirts, appliqué |
| Guipure | None, motifs joined by bars | Heavy | Low within motifs, open between | Bodices, graphic and cotton dresses |
| Corded | Net, raised outlines | Medium to heavy | Medium | Bodices, all-over fitted dresses |
| Embroidered tulle | Tulle | Variable | Variable | Beaded and contemporary dresses |
...
**Will spare motifs be kept?** So that a tear on the day can be patched afterward.

## Care and snagging

Lace catches on everything: rings, bracelets, a fingernail, a chair, a zip. Take rings off when dressing, and ask anyone helping with the buttons to do the same. Sit down on a smoothed skirt rather than a bunched one. If a thread pulls, do not cut it; ease it back with a pin and leave the rest to a professional.

Keep the dress hanging in a breathable bag, never plastic, and away from direct light, which yellows fine net. Afterward, have it cleaned by a specialist rather than a general dry cleaner, and tell them which lace it is. Our [cleaning and preservation guide](/guides/cleaning-and-preserving-wedding-dress/) covers the details.
