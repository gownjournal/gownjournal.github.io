...
P1_FAQ = [
 ...
 ("יש חניה ליד הסטודיו?",
  "[להשלמה] — כדאי לכתוב כאן בדיוק איפה חונים. כלה שמגיעה לסטודיו בפעם הראשונה שואלת את זה, וזו שאלה שמורידה חרדה לפני הנסיעה."),
]
    ...
    <div class="wrap">
      ...
      <div class="pillars">
        ...
        <article class="pillar">
          ...
          <p>כך השעה שלך היא שלך. הודעה בוואטסאפ ל-<a href="tel:{TEL}" dir="ltr">052-555-7106</a> והיא מתואמת.</p>
        </article>
        <article class="pillar">
...
P2_FAQ = [
 ...
 ("אילו שרוולים מתאימים לחתונת קיץ?",
  "תחרה וטול קלילים כמעט לא מורגשים גם בחום. שרוול קצר ורך או שרוול שקוף על הזרוע נותנים את המראה בלי הכובד של בד מלא."),
    ...
    <div class="wrap">
      ...
      <div class="pillars">
        <article class="pillar">
          ...
          <h3>שרוול נשפך</h3>
          <p>טול או תחרה שקופה שנופלים מהכתף. נותן תנועה בתמונות ומראה בוהו מובהק, בלי לכסות באמת.</p>
        </article>
        <article class="pillar">
    ...
    <div class="wrap">
      ...
      <ul class="gowns">
        ...
        <li><div class="gown-more">
          ...
          <p>אם התאהבת בדגם ללא שרוולים, אפשר להוסיף לו אותם בתפירה.</p>
